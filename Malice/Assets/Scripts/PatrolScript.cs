...
public class PatrolScript : MonoBehaviour
{
    ...
    public float speedRun = 2;                      //  Running speed
    ...
    private void Chasing()
    {
        ...
        {
            Move(speedRun);
            navMeshAgent.SetDestination(destination.transform.position);          //  set the destination of the enemy to the player location
        }
